...
dataset_bin = pd.DataFrame(columns= ['E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','E11','E12','E13','S1','S2','S3'])
...
dataset_normalizado = pd.DataFrame(dataset_normalizado, columns= ['E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','E11','E12','E13','S1','S2','S3'])

#**************************************************EMBARALHANDO**************************************

dataset_teste = pd.DataFrame(columns= ['E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','E11','E12','E13','S1','S2','S3'])
dataset_treinamento = pd.DataFrame(columns= ['E1','E2','E3','E4','E5','E6','E7','E8','E9','E10','E11','E12','E13','S1','S2','S3'])
